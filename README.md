...
Игнорировать:
1. Всё содержимое скрытой директории .terraform/
2. Все файлы с расширением .tfstate, а так же содержашие в имени .tfstate.
3. Файл crash.log, а так же файлы содержащие в начале crash. и оканчивающиеся на .log
4. Все файлы с расширением .tfvars и .tfvars.json
5. Файл override.tf и override.tf.json, а так же файлы, оканчивающиеся на
*_override.tf
*_override.tf.json
6. Скрытый файл .terraform.tfstate.lock.info
7. Скрытый файл .terraformrc, а так же terraform.rc
