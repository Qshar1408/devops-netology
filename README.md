...
14. Теперь посмотрите изменения в файле `README.md`, выполнив команды `git diff` и `git diff --staged`.
![Git_01](https://github.com/Qshar1408/devops-netology/blob/main/img/git_004.png)

16. Переведите файл в состояние `staged` (или, как говорят, просто добавьте файл в коммит) командой `git add README.md`.
![Git_01](https://github.com/Qshar1408/devops-netology/blob/main/img/git_005.png)

18. И ещё раз выполните команды `git diff` и `git diff --staged`. Поиграйте с изменениями и этими командами, чтобы чётко понять, что и когда они отображают.
![Git_01](https://github.com/Qshar1408/devops-netology/blob/main/img/git_006.png)

20. Теперь можно сделать коммит `git commit -m 'First commit'`.
![Git_01](https://github.com/Qshar1408/devops-netology/blob/main/img/git_007.png)

22. И ещё раз посмотреть выводы команд `git status`, `git diff` и `git diff --staged`.
